...
<!--                <img style="width: 900px;height: 150px;padding-top: 10px;" :src="muban2_Img"/>-->
                <div v-html="tableData2 "></div>

            </el-card>

            <el-card class="box-card set_padding" v-for="i in input_num" style="width: 960px;min-height: 60px;margin: 0px auto;">
                <div class="card_style">
                    <el-input v-model="namelist[i-1].name" placeholder="请输入被测评人姓名" size="large" clearable style="width: 280px;float:left;padding-top:10px;" ></el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save_store(){
                this.$store.commit('SET_CEPING_TYPE',4)
...
<style lang="less">
    ...
    td[class=first2]:before{
        content: "";
        position: absolute;
        width: 1px;
        height:160px;/*这里需要自己调整，根据td的宽度和高度*/
        top:0;
        left:0;
        background-color: black;
        display: block;
        transform: rotate(-22deg);/*这里需要自己调整，根据线的位置*/
