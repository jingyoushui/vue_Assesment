<template>
    ...
    <div style="width: 1100px;margin: 20px auto;background-color: white;">


        <div style="font-size: 18px ;padding-bottom: 20px;padding-top: 20px;" v-if="mubanlist!=[]">
            私有模板
        </div>
        <el-row style="padding-left: 20px;">
            <el-col :span="5" v-for="(o, index) in mubanlist" :key="o.id" :offset="(index+1)%4 == 1 ? 0 : 1"
                    style="margin-top: 8px">
                <el-card :body-style="{ padding: '0px' }">
                    <!--        @contextmenu.prevent.native="openMenu($event)"用来设置右键菜单-->
                    <el-button type="text" @click="usemuban(o.id,o.type)"
                               @contextmenu.prevent.native="openMenu($event,o.id)">
        ...
        <el-row style="padding-left: 20px;">
            <el-col :span="5" v-for="(o, index) in mubanlist_share" :key="o.id" :offset="(index+1)%4 == 1 ? 0 : 1"
                    style="margin-top: 8px">
                <el-card :body-style="{ padding: '0px' }">
                    <!--        @contextmenu.prevent.native="openMenu($event)"用来设置右键菜单-->
                    <el-button type="text"  @click="usemuban(o.id,o.type)"
...
<script>
    ...
    export default {
        ...
        methods: {
            usemuban(id, type) {
                if (type == 0) {
                    this.$router.push({path:'/h_mubanManage/open_exist',query:{id:id} })
                }
