<template>
    <div style="width:86%;padding-left: 7%;">
        <tree-transfer
                :title=title
                :from_data='fromData'
                :to_data='toData'
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            add(fromData,toData,obj){
                ...
                for( let item of toData){
                    for( let item2 of item.children){
                        this.peoplename.push(item2.label);
                ...
                // var peoplelist = [];
                // peoplelist.push({peoplename:this.peoplename,peopleid:this.peopleid})
                this.$store.commit('SET_PEOPLENAME',this.peoplename)
                this.$store.commit('SET_PEOPLEID',this.peopleid)
            },
            // 监听穿梭框组件移除
            ...
            toback(){
                this.$router.push({path:this.back,query:{type:this.type} })
            },
